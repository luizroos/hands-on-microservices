...
* Para pensar: notem o tipo de ID de [UserEntity](/user-service/src/main/java/web/core/user/UserEntity.java), por que UUID ao invés de um ID númerico? Pense em vantagens e desvantagens desse tipo de dado.